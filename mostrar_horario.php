        ...
        <div class="callapse navbar-collapse" id="navbar-1">
          <ul class="nav navbar-nav navbar-center">
            <li><a href="docente.php">Agregar Docente</a></li>
             <ul class="nav navbar-nav navbar-center">
          <li>
     <form action="busqueda_horario.php" method="GET" autocomplete="off" style="padding-top: 2.5%;" class="form-inline my-3 my-lg-1">
...
<div class="container">
		...
		$sql = $mysqli->query("SET NAMES 'utf8'");	
			...
			$consulta= "SELECT horarios.id, materias.nombre, docentes.nombre, horarios.dias, horarios.grupo, horarios.fecha_inicio, horarios.fecha_fin, horarios.hora_inicio, horarios.hora_fin FROM horarios JOIN materias ON materia_id = materias.id JOIN docentes ON docente_id = docentes.id";
